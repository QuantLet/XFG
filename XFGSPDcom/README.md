...
## [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/qloqo.png" alt="Visit QuantNet">](http://quantlet.de/) **XFGSPDcom** [<img src="https://github.com/QuantLet/Styleguide-and-FAQ/blob/master/pictures/QN2.png" width="60" alt="Visit QuantNet 2.0">](http://quantlet.de/)
...
Description : 'Outputs SPD estimations using Implied Binomial Tree and Rookley"s method for DAX
option data on Jan 3, 1997 with time to maturity being 77 days.'

Keywords : 'Breeden Litzenberger, IBT, Rookley, SPD, bisection-method, black-scholes, delta,
derivative, european-option, gamma, implied binomial tree, implied-volatility, linear
interpolation, local polynomial regression, semiparametric, smoothing, state-price-density'
...
Example : 'XFGSPDcom(): Comparison of different SPD estimations, by Rookley"s method (blue) and IBT
(black), bandwidth=180.'

```

![Picture1](Comparison of different SPD estimations.png)
